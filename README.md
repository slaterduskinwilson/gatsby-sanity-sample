...
1. Go to your [project’s API settings on manage.sanity.io](https://manage.sanity.io/projects/mr9eurcx/settings/api) and create a token with read rights.
